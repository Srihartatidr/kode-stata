...
tabulate m4_done consent

*jika ada, list
list subject_id if m4_done==1 & consent==0
replace m4_done=0 in 
...
*terdapat 2 nc yang no show saat Fu-4 yaitu id 25116601 dan 25142201
...
*jika ada, list
list subject_id if m8_done==1 & consent==0
list subject_id if m4_done==0 & m8_done==1
...
*menghitung m8_done dgn mempertimbangkan new entry dari baseline
tabulate subject_cat m8_done if consent==1 & left==1
tabulate subject_cat m8_done if consent==1 & left==0
list subject_id subject_cat left_reason m8_done if left==1 & m8_done==1

*menghitung m8_done dgn mempertimbangkan new entry dari bulan 4
tabulate subject_cat m8_done if consent==1 & m4_left==1
tabulate subject_cat m8_done if consent==1 & m4_done==0
tabulate subject_cat m8_done if consent==1 & m4_done==1
list subject_id subject_cat m4_done m4_left_reason m8_done if m4_left==1 & m8_done==1
list subject_id subject_cat m4_done m4_left_reason m8_done if m4_done==0 & m8_done==1

*melihat siapa yang belum di-fu m8 per subject_cat
browse subject_id date_baseline if m8_done==0 & subject_cat==2 & m4_left==0
browse subject_id date_baseline if m8_done==0 & subject_cat==3 & m4_left==0
